#!/bin/bash
# === KO annotation via direct hmmsearch against KOfam profiles (02_mag_track) ===
...
#   QUERY_FAA         = $PROJECT/02_mag_track/03_master_orf/mag.master.faa
#   OUT               = $PROJECT/02_mag_track/06_kofam
#   THREADS           = 112
...
QUERY_FAA=${QUERY_FAA:-$PROJECT/02_mag_track/03_master_orf/mag.master.faa}
OUT=${OUT:-$PROJECT/02_mag_track/06_kofam}
THREADS=${THREADS:-112}
