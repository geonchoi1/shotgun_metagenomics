#!/bin/bash
# === KO annotation via direct hmmsearch against KOfam profiles (01_plasmid_track) ===
...
#   QUERY_FAA         = $PROJECT/01_plasmid_track/04_master_orf/master_1869.faa
#   OUT               = $PROJECT/01_plasmid_track/07_kofam
#   THREADS           = 112
...
QUERY_FAA=${QUERY_FAA:-$PROJECT/01_plasmid_track/04_master_orf/master_1869.faa}
OUT=${OUT:-$PROJECT/01_plasmid_track/07_kofam}
THREADS=${THREADS:-112}
