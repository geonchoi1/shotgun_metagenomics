...
export ENV_SNAKEMAKE_CAMARGO=${ENV_SNAKEMAKE_CAMARGO:-snakemake-camargo}
export CAMARGO_PIPELINE=${CAMARGO_PIPELINE:-$HOME/tools/bioinformatics-snakemake-pipelines/contig-ani-leiden-clustering-pipeline}
export PLSDB_PTU_TABLE=${PLSDB_PTU_TABLE:-$DB_ROOT/plsdb/plsdb_ptu_labels.tsv}
...
# ============= Additional envs (added per agent reports) =============
export ENV_GENOMAD=${ENV_GENOMAD:-genomad}
export ENV_PRODIGAL=${ENV_PRODIGAL:-base}
export ENV_BWA=${ENV_BWA:-bowtie2}
export ENV_FEATURECOUNTS=${ENV_FEATURECOUNTS:-coverm}
