...
for step in 04_pfam 05_ncbifam 06_kofamscan 07_eggnog 08_amrfinder 10_vfdb 13_dbcan 18_dbscan_swa \
            19_isescan 20_integronfinder 21_iceberg3 22_cctyper 16_bacmet 17_defensefinder 22_dbapis; do
